...
from ConvolutionalNeuralNetwork.deeplab.core import xception
from ConvolutionalNeuralNetwork.slim.nets.mobilenet import mobilenet as mobilenet_lib
from ConvolutionalNeuralNetwork.slim.nets.mobilenet import mobilenet_v2
