...
class KMeans():
    def __init__(self, n_clusters=20, max_iter=150, tol=1e-3):
...
def segmentImage():
    img = spm.imread("Kaggle_Image_TrainingData/train/0cdf5b5d0ce1_01.jpg")
    img = transform.resize(img, (200, 200,1))
